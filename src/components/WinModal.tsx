...
// Simple React/CSS Confetti System
const Confetti = () => {
  const [particles] = React.useState(() => {
    const colors = ['#fde047', '#38bdf8', '#c084fc', '#4ade80', '#fb923c'];
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-md p-6 rounded-3xl glass-panel border border-white/20 shadow-2xl text-center overflow-hidden">
        ...
        <div className="absolute -top-20 -left-20 w-40 h-40 bg-purple-500/30 rounded-full blur-3xl z-0" />
        <div className="absolute -bottom-20 -right-20 w-40 h-40 bg-indigo-500/30 rounded-full blur-3xl z-0" />
